...
import { checkTokenizability } from '../../services/mockAiService';
import { TokenizabilityReport } from '../../types';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
               ...
               <div className="space-y-6">
                  <div className="bg-gradient-to-br from-indigo-600 to-violet-700 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
                     ...
                     <p className="text-sm text-indigo-5 leading-relaxed opacity-90">{report.nextSteps}</p>
                  </div>
               </div>
            </div>
