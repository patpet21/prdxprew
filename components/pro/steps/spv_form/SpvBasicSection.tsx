        ...
        <div>
          ...
          <div className="relative">
              ...
              >
                  ...
                  {/* Fallback option if the current value isn't in PRO_COUNTRIES */}
                  {spv.spvCountry && !PRO_COUNTRIES.find(c => c.code === spv.spvCountry) && (
                      <option value={spv.spvCountry}>{spv.spvCountry}</option>
                  )}
              </select>
          ...
          {availableForms.length > 0 ? (
              <div className="relative">
                  ...
                  >
                      ...
                      {/* Ensure current value shows if not in available list (e.g. manual override) */}
                      {spv.spvLegalForm && !availableForms.includes(spv.spvLegalForm) && (
                          <option value={spv.spvLegalForm}>{spv.spvLegalForm}</option>
                      )}
                  </select>
