...
export const FeasibilityReport: React.FC<Props> = ({ data }) => {
  const feasibility = data.proReports?.feasibility || {
      ...
      financialScore: 0,
      legalScore: 0,
      structuralComplexity: 'Pending',
      strengths: ['Waiting for AI Analysis'],
      weaknesses: ['Waiting for AI Analysis'],
      mandatoryActions: ['Run Report Generator']
  };
    ...
    <div className="animate-fadeIn space-y-8">
                ...
                <div>
                    ...
                    <div className="mb-4">
                        ...
                        <ul className="space-y-1">
                            {feasibility.strengths?.map((s: string, i: number) => (
                    ...
                    <div>
                        ...
                        <ul className="space-y-1">
                            {feasibility.weaknesses?.map((w: string, i: number) => (
                                <li key={i} className="text-sm text-slate-300 flex items-start gap-2">
        ...
        <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {feasibility.mandatoryActions?.map((action: string, i: number) => (
