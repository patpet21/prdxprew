                ...
                <div>
                    ...
                    {data.property.raise_amount && distData.averageExpectedTicket ? (
                        <div className="text-3xl font-display font-bold text-emerald-400">
                            {Math.ceil(data.property.raise_amount / (distData.averageExpectedTicket || 1)).toLocaleString()} <span className="text-lg text-slate-500 font-sans font-normal">Investors</span>
                        </div>
                    ) : (
