...
function AppContent() {
  ...
  const handleNavigate = (page: string) => {
      // Standard routes always allowed
      if (!page.startsWith('PRO_') && !page.startsWith('ENTERPRISE_')) {
      ...
      if (AccessControl.isUnlocked()) {
          ...
          // Force Redirect to Access Request
          setRoute('ACCESS_REQUEST');
      }
  };

  const handleUnlockSuccess = () => {
      // Called when code is validated
      // Fetch user profile if needed or just set route
      setRoute('PRO_DASHBOARD');
  };
  ...
  const renderContent = () => {
    switch (route) {
        ...
        case 'UNLOCK_ACCESS': return <UnlockAccessPage onUnlock={handleUnlockSuccess} onNavigate={handleNavigate} />;
