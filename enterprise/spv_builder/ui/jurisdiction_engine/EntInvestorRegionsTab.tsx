...
export const EntInvestorRegionsTab: React.FC<Props> = ({ data, updateData }) => {
  ...
  const toggleRegion = (id: string) => {
    ...
    if (current.includes(id)) {
        updateData('jurisdiction', { ...jurisdiction, targetRegions: current.filter(r => r !== id) });
    } else {
        updateData('jurisdiction', { ...jurisdiction, targetRegions: [...current, id] });
    }
  };
  ...
  const toggleFlag = (id: string) => {
    ...
    if (current.includes(id)) {
        updateData('jurisdiction', { ...jurisdiction, sensitiveFlags: current.filter(f => f !== id) });
    } else {
        updateData('jurisdiction', { ...jurisdiction, sensitiveFlags: [...current, id] });
    }
  };
